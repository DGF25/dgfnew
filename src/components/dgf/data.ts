...
export interface Company {
   ...
   */
  logo?: string;
  /** Position in the "Selected Investments" tab. That tab mixes active and
   *  realized companies, so its order cannot come from this array — the array
   *  order is what drives the Active and Realized tabs. Only highlighted
   *  companies need it. */
  sel?: number;
  /** Dark badge background. For logos that are light or near-white: on the
   *  default white badge they disappear once grayscaled at rest. */
  badgeDark?: boolean;
}

export const companies: Company[] = [
  // ── Active ── ordem desta lista = ordem da aba "Active".
  { id: 1, ini: "TR", name: "Tractian", desc: "Industrial predictive maintenance with IoT and AI", type: "ativo", highlight: true, sel: 1, site: "https://tractian.com" },
  { id: 2, ini: "SO", name: "Sólides", desc: "People management for SMBs", type: "ativo", highlight: true, sel: 2, site: "https://solides.com.br" },
  { id: 3, ini: "ME", name: "Memed", desc: "Digital prescription platform for physicians", type: "ativo", highlight: true, sel: 3, site: "https://memed.com.br" },
  { id: 4, ini: "IN", name: "InHire", desc: "Data-driven recruiting for mid-market companies", type: "ativo", highlight: true, sel: 4, site: "https://inhire.com.br" },
  { id: 5, ini: "MG", name: "Maggu", desc: "AI copilot for pharmacy retail", type: "ativo", highlight: true, sel: 5, site: "https://maggu.ai" },
  { id: 61, ini: "MK", name: "Makasí", desc: "Digital construction financing platform", type: "ativo", highlight: true, sel: 6, badgeDark: true, site: "https://www.makasi.com.br" },
  { id: 7, ini: "MF", name: "Mudflap", desc: "Financial platform for truckers in the US", type: "ativo", highlight: true, sel: 7, site: "https://www.mudflapinc.com" },
  { id: 62, ini: "PL", name: "Pluggy", desc: "Open Finance API for bank data and payments", type: "ativo", highlight: true, sel: 8, site: "https://www.pluggy.ai" },
  { id: 8, ini: "TK", name: "Takeat", desc: "All-in-one foodservice operating system", type: "ativo", highlight: true, sel: 9, site: "https://www.takeat.app" },
  { id: 9, ini: "D4", name: "Data4Sales", desc: "B2B commercial intelligence platform", type: "ativo", site: "https://en.data4sales.com" },
  ...
  // ── Realized ── ordem desta lista = ordem da aba "Realized".
  { id: 10, ini: "RD", name: "RD Station", desc: "Marketing automation, acquired by TOTVS", type: "saida", highlight: true, sel: 11, site: "https://www.rdstation.com" },
  { id: 11, ini: "DA", name: "Daitan", desc: "Software engineering, acquired by Coforge", type: "saida", highlight: true, sel: 12, site: "https://www.coforge.com" },
  { id: 25, ini: "LG", name: "Logocenter", desc: "ERP software, merged into TOTVS", type: "saida", highlight: true, sel: 14, site: "https://www.totvs.com" },
  { id: 26, ini: "BU", name: "Buddemeyer", desc: "Textile company, realized exit", type: "saida", site: "https://www.buddemeyer.com.br" },
  { id: 56, ini: "RA", name: "Reclame Aqui", desc: "Consumer reputation platform, realized exit", type: "saida", highlight: true, sel: 10, site: "https://reclameaqui.com.br" },
  ...
  { id: 12, ini: "MO", name: "Mosyle", desc: "Apple device management, realized exit", type: "saida", highlight: true, sel: 13, site: "https://mosyle.com" },
  ...
  { id: 54, ini: "GF", name: "Geofusion", desc: "Geomarketing intelligence, acquired by Cortex", type: "saida", site: "https://www.geofusion.com.br" },
