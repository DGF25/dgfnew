...
export const companies: Company[] = [
  ...
  { id: 40, ini: "CT", name: "Cognitec", desc: "Software and technology services, realized exit", type: "saida" },
  ...
  { id: 44, ini: "EX", name: "Exopro", desc: "Foreign-trade B2B platform, realized exit", type: "saida" },
  ...
  { id: 47, ini: "AP", name: "APS", desc: "Industrial planning software, realized exit", type: "saida" },
